...
public class AbsoluteFieldDrive extends Command {
   ...
   * headingVertical are the Cartesian coordinates from which the robot's angle will be derived they
   * will be converted to a polar angle, which the robot will rotate to.
   *
